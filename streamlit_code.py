...
if page == "Homepage": 
    ...
    with tab1:
        ...
        data = pd.read_csv("C:/Users/manos/OneDrive/Desktop/MSU/Spring 2025/STT 811 Appl STT Modeling for Data Sci/Project/aidata_clean_avg.csv")
        st.dataframe(data.iloc[:5, :3].head())
        st.write("Major topics covered in the dataset:")
        imageida0 = Image.open("plots\Trigrams.png")
        ...
        imagepp1 = Image.open("plots\missing_heatmap.png")
        ...
        imagepp2 = Image.open("plots\dataset.png")
        ...
        imagepp3 = Image.open("plots\scree_plot.png")
        ...
        with open("plots\pca_plot.json", "r") as f:
    ...
    with tab2:
        imageida4 = Image.open("plots\human_cloud.png")
        imageida5 = Image.open("plots\AI_CLOUD.png")
        imageida7 = Image.open("plots\TOPwordshuman.png")
        imageida8 = Image.open("plots\TOPwordsai.png")
        ...
        col1, col2 = st.columns(2)
        imageida1 = Image.open("plots\AI_length_hist.png")
        with col1:
            st.image(imageida1, use_column_width=True)
        imageida2 = Image.open("plots\Human_length_hist.png")
        with col2:
        ...
        col1, col2 = st.columns(2)
        imageida3 = Image.open("plots\pairplot.png") 
        imageida6 = Image.open("plots\corr_heatmap.png")
        with col2:
        ...
        imageida9 = Image.open("plots\sent_dist.png") 
        imageida10 = Image.open("plots\sent_plot.png")
        col1, col2 = st.columns(2)
        with col1:
        ...
        imageida11 = Image.open("plots\FLesh_score.png")
        ...
        imageida12 = Image.open("plots\ANS_sim.png") 
        imageida13 = Image.open("plots\Q_sim.png")
        col1, col2 = st.columns(2)
        with col1:
    ...
    with tab3:
        ...
        with tab1:  
            ...
            imagemod1 = Image.open("plots\model_accuracy_plot.png.")
